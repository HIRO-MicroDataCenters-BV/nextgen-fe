  ...
  return {
    ...
    messages: {
      en: {
        ...
        admin: {
          title: "Admin",
          subtitle: "Every contract, and what has happened to it",
          denied: {
            title: "Admins only",
            description:
          ...
          disabled: {
            ...
            description:
              "This server runs a production build, which refuses the development login. Real login is needed first.",
          },
          error: {
            access: "Could not check whether you are an admin.",
            unavailable: "The Clearing House cannot be reached right now.",
            failed: "Could not load contracts.",
            retry: "Try again",
          },
          filter: {
            status: "Status",
          ...
          drawer: {
            ...
            history: "History",
            issued: "Issued",
            status_changed: "Last status change",
            history_empty: "No history recorded.",
          ...
          event: {
            ...
            refused: "Refused: {from} → {to}",
            refused_plain: "Refused change",
            by: "by",
            no_actor: "No actor recorded",
            identified_via: "Identified via {source}",
          },
          column: {
            contract: "Contract",
            order: "Order",
